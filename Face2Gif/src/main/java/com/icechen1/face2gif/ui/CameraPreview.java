...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Activity activity, Camera c, LayoutMode mode) {
    ...
    protected void configureCameraParameters(Camera.Parameters cameraParams, boolean portrait) {
        ...
        //cameraParams.setPreviewFormat(ImageFormat.YUY2);
        for (int f:cameraParams.getSupportedPreviewFormats()){
            if (f == ImageFormat.YUY2) cameraParams.setPreviewFormat(ImageFormat.YUY2);
        }
        if (DEBUGGING) {
